...
<head>
    ...
    %{--<link href="index-2.html#" data-style="styles" rel="stylesheet">--}%
                                ...
                                <ul class="dropdown-menu dropdown-menu-right dropdown-animation">
                                    <li>
                                        <form class="login-form">
                                            ...
                                            <ul>
                                                <li><a href="index-2.html#">Forgot your password?</a></li>
                                            </ul>
                                        ...
                                        <ul class="nav navbar-nav navbar-right">
                                            <li class="dropdown active">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="index-landing.html">Home - Landing <span class="badge">New</span></a></li>
                                                    <li><a href="index-text-rotator.html">Home - Text Rotator <span class="badge">New</span></a></li>
                                                    <li><a href="index-video-background.html">Home - Video Bg <span class="badge">New</span></a></li>
                                            ...
                                            <li class="dropdown">
                                                <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Features</a>
                                                <ul class="dropdown-menu">
                                                    <li class="dropdown">
                                                        <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Email Templates <span class="default-bg badge">v1.1</span></a>
                                                        <ul class="dropdown-menu">
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Headers <span class="default-bg badge">v1.2</span></a>
                                                        <ul class="dropdown-menu">
                                                            <li class="dropdown">
                                                                <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Layouts <span class="default-bg badge">v1.1</span></a>
                                                                <ul class="dropdown-menu">
                                                            ...
                                                            <li class="dropdown">
                                                                <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Transparent <span class="default-bg badge">v1.2</span></a>
                                                                <ul class="dropdown-menu">
                                                            ...
                                                            <li class="dropdown">
                                                                <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Left Side Header  <span class="default-bg badge">v1.2</span></a>
                                                                <ul class="dropdown-menu">
                                                            ...
                                                            <li class="dropdown">
                                                                <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Right Side Header <span class="default-bg badge">v1.2</span></a>
                                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Footers</a>
                                                        <ul class="dropdown-menu">
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Login/Sign Up <span class="default-bg badge">v1.2</span></a>
                                                        <ul class="dropdown-menu">
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Pricing tables</a>
                                                        <ul class="dropdown-menu">
                                                    ...
                                                    <li class="dropdown">
                                                        <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Icons</a>
                                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="dropdown mega-menu">
                                                <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Pages</a>
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <div class="row">
                                                            <div class="col-lg-4 col-md-3 hidden-sm">
                                                                ...
                                                                <asset:image src="theme/images/section-image-3.png" alt="iDea"/>
                                                            </div>
                                            ...
                                            <!-- mega-menu start -->
                                            <li class="dropdown mega-menu">
                                                <a href="index-2.html#" class="dropdown-toggle" data-toggle="dropdown">Components</a>
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <div class="row">
                                                            <div class="col-sm-4 col-md-6">
                                                                ...
                                                                <asset:image src="theme/images/section-image-1.png" alt="iDea"/>
                                                            </div>
                ...
                <div class="slider-banner-2 bullets-with-bg">
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on" data-title="Slide 1">
                            ...
                            <!-- main image -->
                            %{--<img src="images/slider-2-slide-1.jpg"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">--}%
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="active"><a href="index-2.html#htab1" role="tab" data-toggle="tab"><i class="fa fa-home pr-5"></i>Lorem Ipsum</a></li>
                        <li><a href="index-2.html#htab2" role="tab" data-toggle="tab"><i class="fa fa-user pr-5"></i>Top Notch 24/7 Support</a></li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
                        <div class="tab-pane fade in active" id="htab1">
                            <div class="row">
                                <div class="col-md-12">
                                    <p>Dolore architecto facilis illo corporis accusamus quaerat, totam in dicta mollitia omnis! Facere, quas. Vel excepturi tenetur, quaerat. Laborum exercitationem, consequuntur minus.</p>
                ...
                <div class="col-md-12">
                    ...
                    <div class="filters margin-bottom-clear">
                        <ul class="nav nav-pills">
                            <li class="active"><a href="index-2.html#" data-filter="*">All</a></li>
                            <li><a href="index-2.html#" data-filter=".web-design">Web design</a></li>
                            <li><a href="index-2.html#" data-filter=".app-development">App development</a></li>
                            <li><a href="index-2.html#" data-filter=".site-building">Site building</a></li>
                        </ul>
                    </div>
                    <!-- isotope filters end -->
                    ...
                    <div class="isotope-container row grid-space-20">
                        <div class="col-sm-4 isotope-item web-design margin-bottom-clear">
                            <div class="box-style-1 gray-bg">
                                <div class="overlay-container">
                                    ...
                                    <asset:image src="theme/images/portfolio-1.jpg" alt=""/>
                                ...
                                <a href="portfolio-item.html" class="btn btn-default">Read More</a>
                            </div>
                        </div>
                        <div class="col-sm-4 isotope-item app-development margin-bottom-clear">
                            <div class="box-style-1 gray-bg">
                                <div class="overlay-container">
                                    <asset:image src="theme/images/portfolio-2.jpg" alt=""/>
                                    <a href="portfolio-item.html" class="overlay small">
                                        <i class="fa fa-plus"></i>
                        ...
                        <div class="col-sm-4 isotope-item web-design margin-bottom-clear">
                            <div class="box-style-1 gray-bg">
                                <div class="overlay-container">
                                    <asset:image src="theme/images/portfolio-3.jpg" alt=""/>
                                    <a href="portfolio-item.html" class="overlay small">
                                        <i class="fa fa-plus"></i>
                                        <span>Web Design</span>
                                    </a>
                        ...
                        <div class="col-sm-4 isotope-item site-building margin-bottom-clear">
                            <div class="box-style-1 gray-bg">
                                <div class="overlay-container">
                                    <asset:image src="theme/images/portfolio-4.jpg" alt=""/>
                                    <a href="portfolio-item.html" class="overlay small">
                                        <i class="fa fa-plus"></i>
                        ...
                        <div class="col-sm-4 isotope-item app-development margin-bottom-clear">
                            <div class="box-style-1 gray-bg">
                                <div class="overlay-container">
                                    <asset:image src="theme/images/portfolio-5.jpg" alt=""/>
                                    <a href="portfolio-item.html" class="overlay small">
                                        <i class="fa fa-plus"></i>
                                        <span>App Development</span>
                                    </a>
                        ...
                        <div class="col-sm-4 isotope-item web-design margin-bottom-clear">
                            <div class="box-style-1 gray-bg">
                                <div class="overlay-container">
                                    <asset:image src="theme/images/portfolio-6.jpg" alt=""/>
                                    <a href="portfolio-item.html" class="overlay small">
                                        <i class="fa fa-plus"></i>
                                        <span>Web Design</span>
                                    </a>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="owl-carousel clients">
                        <div class="client">
                            <a href="index-2.html#"><asset:image src="theme/images/client-2.png" alt=""/></a>
                        </div>
                        <div class="client">
                            <a href="index-2.html#"><asset:image src="theme/images/client-2.png" alt=""/></a>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="footer-content">
                            <div class="logo-footer">
                                <asset:image src="theme/images/logo_red_footer.png" alt=""/>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                        ...
                        <div class="footer-content">
                            ...
                            <div class="gallery row">
                                <div class="gallery-item col-xs-4">
                                    <div class="overlay-container">
                                        <asset:image src="theme/images/gallery-1.jpg" alt=""/>
                                        <a href="portfolio-item.html" class="overlay small">
...
%{--<div class="style-switcher closed">--}%
    %{--<div class="header">--}%
        %{--<a class="trigger" href="index-2.html#"><i class="icon-tools"></i></a>--}%
